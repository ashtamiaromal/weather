...
function App() {
  ...
  return (
    <div className='App'>
        <Header/>
        <div className="d-flex justify-content-center align-items-center mt-0" style={{ height: '100vh' }}>
          <Card  style={{ width: '90rem', background: 'url("https://i.pinimg.com/originals/9f/72/a4/9f72a4881c7f3791da3dadf12e218efb.gif")', backgroundSize: 'cover' }}>
